...
public class AdminHouseController {
	...
	public String index(Model model,
		...
		//List<House> houses = houseRepository.findAll(); Pageableインターフェースで不必要に
		Page<House> housePage; // = houseRepository.findAll(pageable);検索機能追加時に、RepositoryにfindBy__likeメソッドを分岐して以下になった
		...
		//model.addAttribute("houses", houses);　同上
	...
	public String upadate(@ModelAttribute @Validated HouseEditForm houseEditForm, BindingResult bindingResult,
			RedirectAttributes redirectAttributes) {
		if (bindingResult.hasErrors()) {
			return "admin/houses/edit";
		}
